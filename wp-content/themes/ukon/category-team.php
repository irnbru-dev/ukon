    ...
    <div class="container">
        <div class="page-wrap">
            ...
            <aside class="left-menu">
                ...
                <?php if( is_category('team') || is_object_in_taxonomy( $post, 'team' ) || is_object_in_taxonomy( $post, 'reviews' ) ) { ?>
                <ul class="left-menu__list">
                    <?php echo wp_nav_menu('company') ?>
                </ul>
                <?php } ?>
            ...
            <div class="content">
                ...
                <div class="banner" style="background-image: url(/wp-content/themes/ukon/img/team_banner.jpg);">
