...
function ukon_scripts()
{
    ...
    wp_enqueue_style('app-style', get_template_directory_uri() . '/css/style.min.css', array(), '0.0.3');
    ...
    wp_enqueue_script('app-script', get_template_directory_uri() . '/js/app.min.js', array(), '0.0.2', true);
}
